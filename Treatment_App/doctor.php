...
<?php
    ...
    $output="";
    $output .='<link rel="stylesheet" href="index.css">
                <div class="navbar">
                <ul>
                ...
                <h1> List of all alloated Patient</h1>
    ...
    while($row=mysqli_fetch_assoc($result)){
        ...
        <td>{$row["status"]}</td><td><button><a href='delete_data.php'>Delete</a></button></td><td><button><a href='update_data.php'>Update</a></button></td></tr>";
    }
    $output .="</table>";
    mysqli_close($con);
    echo $output;
